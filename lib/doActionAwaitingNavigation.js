...
const doActionAwaitingNavigation = async (options, action) => {
  ...
  // console.log(Date.now() + ', id = ' + id + 'xxx doActionAwaitingNavigation start', action.toString ? action.toString() : action);
  ...
  // console.log(Date.now() + ', id = ' + id + 'xxx doActionAwaitingNavigation reset promises');
  ...
  try {
    // console.log(Date.now() + ', id = ' + id + " xxx doActionAwaitingNavigation actio");

    await action();

    // console.log(Date.now() + ', id = ' + id + " xxx doActionAwaitingNavigation waitForPromises");
    ...
    do {
      // console.log(Date.now() + ', id = ' + id + " xxx doActionAwaitingNavigation waitForNavigation " + promises.length);
      promiseCount = promises.length
      await waitForNavigation(timeouts, options.navigationTimeout, promises);
    }
    while(promises.length != promiseCount)
    
    // console.log(Date.now() + ', id = ' + id + " xxx doActionAwaitingNavigation waitForNavigation complete");
