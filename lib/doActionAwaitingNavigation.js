...
const doActionAwaitingNavigation = async (options, action) => {
  ...
  console.log('id = ' + id + 'xxx doActionAwaitingNavigation start', action.toString());
  ...
  try {
    ...
    console.log('id = ' + id + 'xxx doActionAwaitingNavigation error', e);
    if (e === 'Timedout') {
      throw new Error(
    ...
    console.log('id = ' + id + " xxx doActionAwaitingNavigation finish");
