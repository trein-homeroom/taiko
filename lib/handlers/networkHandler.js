...
const logPromises = () => {
  ...
  console.log('xxx logPromises, remaining listeners:', Object.keys(requestPromises));
  console.trace();
}
...
const resetPromises = () => {
  ...
  console.log('xxx reset promises, remaining listeners:', Object.keys(requestPromises));
  console.trace();
  ...
  for (let id in requestPromises) {
    console.log('xxx calling dangling listener:', id);
    requestPromises[id]();
  }
